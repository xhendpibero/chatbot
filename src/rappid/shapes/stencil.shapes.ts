...
export enum ShapeTypesEnum {
  ...
  BOX_MESSAGE = "stencil.BoxMessage",
  USER_INPUT = "stencil.UserInput",
  BOT_RESPONSE = "stencil.BotResponse",
  FALLBACK = "stencil.Fallback",
  JSON_API = "stencil.JsonApi",
  GO_TO_ELEMENT = "stencil.GoToElement",
  WEBHOOK = "stencil.Webhook",
  CLOSE_CHAT = "stencil.CloseChat",
...
const UserInput = dia.Element.define(
...
const BotResponse = dia.Element.define(
...
const Fallback = dia.Element.define(
...
const JsonApi = dia.Element.define(
...
const GoToElement = dia.Element.define(
...
const Webhook = dia.Element.define(
...
const CloseChat = dia.Element.define(
  ShapeTypesEnum.CLOSE_CHAT,
  {
    name: "CloseChat",
    size: { width: SHAPE_SIZE, height: SHAPE_SIZE },
    attrs: {
...
const BoxMessage = dia.Element.define(
